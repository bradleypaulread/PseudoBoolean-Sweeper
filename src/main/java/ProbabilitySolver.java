...
// * board configuration and uses SAT4J's main.java.PBSolver to iterate over all models and
...
// * @since 2019-03-11
// */
//public class ProbabilitySolver extends AbstractSolver {
//
//    /**
//     * Constructor for main.java.ProbabilitySolver.
//     *
...
//
//    /**
//     * Constructor for main.java.ProbabilitySolver. The solver can be stopped by changing the
...
//        } else {
//            String detail = "Strategically Selecting main.java.Cell " + bestCell + " with prob. "
//                    + probs.get(bestCell)
//                    .doubleValue();
...
//        cells = game.getCells();
//        // Key = main.java.Cell
//        // Value = main.java.Cell appearance as mine count
//        Map<Cell, BigInteger> cellMineCount = new HashMap<>();
//
//        // Key = main.java.Cell
//        // Value = main.java.Cell's final probabiltiy of being a mine
