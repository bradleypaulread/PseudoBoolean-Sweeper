...
// * board configuration and uses SAT4J's main.java.PBSolver to solve them.
// *
// * @author Bradley Read
// * @version 1.0
// * @since 2019-03-11
// */
//public class PBSolver extends AbstractSolver {
//
//	/**
//	 * Constructor for main.java.PBSolver.
//	 *
...
//
//	/**
//	 * Constructor for main.java.PBSolver. The solver can be stopped by changing the passed
...
//					game.decrementMines();
//					String detail = "Flagging " + current + " as main.java.Cell is a Guarenteed Mine";
...
//					} else {
//						String detail = "Selecting " + current + " as main.java.Cell is Safe";
//						game.setDetail(detail);
...
//	 * Still has issues. private Map<main.java.Cell, Boolean> getKnownCells() { IPBSolver
//	 * pbSolver = SolverFactory.newDefault(); cells = game.getCells(); Map<main.java.Cell,
//	 * Boolean> results = new HashMap<>(); List<main.java.Cell> closedShore =
//	 * getShoreClosedCells(); List<main.java.Cell> seaCells = getSeaCells(); try {
//	 * genConstraints(pbSolver); } catch (ContradictionException e) { } for (int i =
//	 * 0; i < closedShore.size() && running.get() && !Thread.interrupted(); i++) {
//	 * main.java.Cell current = closedShore.get(i); // Generate the known constraints on the
...
//	 * = true; for (main.java.Cell c : seaCells) { results.put(c, isMine); } }
...
//	 * boolean isMine = false; for (main.java.Cell c : seaCells) { results.put(c, isMine); } }
